...
Все кандидаты 1–6 из первой версии отчёта закрыты в релизах 2026.9.0–2026.9.4. Остальное — осознанно вне скоупа HA (оплата, управление TOTP, ЕСИА, смена пароля) или малоценно.
